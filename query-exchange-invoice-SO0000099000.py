...
# Hoa don preview ngay 17/08/2026, ten khach hien thi nguyen "(Doi hang A-A)
# THEO DANH SACH DINH KEM" - khong bi cat tien to nhu ky vong. Kiem tra
# GroupCode/CustomerGroupCode cua khach hang gan voi don SO0000099000 de xac
# dinh co phai isExchangeCustomer = false hay khong.
SQL = r'''
SELECT
    so."OrderNumber",
    so."PSINumber",
...
WHERE so."OrderNumber" = 'SO0000099000';
'''
