...
# Tim SalesOrder co InvoiceNumber bat dau bang "1026." (so hoa don 1026,
# hoa don mau ngay 14/07/2026, ky hieu 1C26TDN) va lay ten khach hang EXCHANGE
# di kem de so sanh voi don loi SPI10000000896.
SQL = r'''
SELECT
    so."OrderNumber",
    so."PSINumber",
    so."InvoiceNumber",
    split_part(so."InvoiceNumber", '.', 1) AS "InvoiceNumberOnly",
    so."Documentdate",
...
WHERE split_part(so."InvoiceNumber", '.', 1) = '1026'
