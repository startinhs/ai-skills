...
import com.bixolon.sample.UsbPeripheralFragment;
...
public class BixolonPrinter implements ErrorListener, OutputCompleteListener, StatusUpdateListener, DirectIOListener, DataListener {
    ...
    private String getProductName(String name) {
        ...
        } else if ((name.equals("SPP-R230"))) {
            productName = BXLConfigLoader.PRODUCT_NAME_SPP_R230;
        ...
        } else if ((name.equals("SPP-300"))) {
            productName = BXLConfigLoader.PRODUCT_NAME_SPP_300;
        ...
        } else if ((name.equals("SRP-380plus"))) {
            productName = BXLConfigLoader.PRODUCT_NAME_SRP_380PLUS;
        } else if ((name.equals("SRP-382plus"))) {
            productName = BXLConfigLoader.PRODUCT_NAME_SRP_382PLUS;
        ...
        } else if ((name.equals("SRP-Q300II"))) {
            productName = BXLConfigLoader.PRODUCT_NAME_SRP_Q300II;
        ...
        } else if ((name.equals("SRP-B300II"))) {
            productName = BXLConfigLoader.PRODUCT_NAME_SRP_B300II;
        ...
        } else if ((name.equals("SRP-S300II"))) {
            productName = BXLConfigLoader.PRODUCT_NAME_SRP_S300II;
        } else if ((name.equals("SRP-S3000"))) {
            productName = BXLConfigLoader.PRODUCT_NAME_SRP_S3000;
        } else if ((name.equals("SRP-G300"))) {
            productName = BXLConfigLoader.PRODUCT_NAME_SRP_G300;
        ...
        } else if ((name.equals("BK5-4"))) {
            productName = BXLConfigLoader.PRODUCT_NAME_BK5_4;
        ...
        } else if ((name.equals("FEC-90IIT"))) {
            productName = BXLConfigLoader.PRODUCT_NAME_FEC_90IIT;
        }else if ((name.equals("FEC-90IIIT"))) {
            productName = BXLConfigLoader.PRODUCT_NAME_FEC_90IIIT;
        }else if ((name.equals("FEC-92IIT"))) {
            productName = BXLConfigLoader.PRODUCT_NAME_FEC_92IIT;
        }else if ((name.equals("FEC-92IIIT"))) {
            productName = BXLConfigLoader.PRODUCT_NAME_FEC_92IIIT;
        }
    ...
    public boolean printImage(String path, int width, int alignment, int brightness, int dither, int compress, int thres) {
        boolean ret = true;
...
//            posPrinter.printBitmap(buffer.getInt(0), path, width, alignment);
            posPrinter.printBitmap(buffer.getInt(0), bitmap, width, alignment, thres);
    ...
    public boolean printPdf(Uri uri, int width, int alignment, int startPage, int endPage, int brightness, int dither, int compress, int thres) {
        boolean ret = true;
        ...
        try {
            ...
            posPrinter.printPDFFile(buffer.getInt(0), uri, width, alignment, startPage, endPage, thres);
        } catch (JposException e) {
            e.printStackTrace();
            ret = false;
        }
    ...
    public boolean ejectAndRetractPaper(int timeoutSeconds) {
        try {
            if (!posPrinter.getDeviceEnabled()) {
                return false;
            }

            posPrinter.ejectAndRetractPaper(timeoutSeconds);
        } catch (JposException e) {
            e.printStackTrace();
    ...
    public boolean sendUsbPeripheralData(int deviceID, byte[] data){
        boolean ret = true;
        try {
            if (!posPrinter.getDeviceEnabled()) {
                return false;
    ...
    public byte[] readUsbPeripheralData(int deviceID){
        byte[] devices = null;
        try {
            if (!posPrinter.getDeviceEnabled()) {
                return null;
    ...
    public byte[] getSerialSettingData(int deviceID){
        byte[] data = null;
        try {
            if (!posPrinter.getDeviceEnabled()) {
                return null;
    ...
    public boolean setSerialSettingData(int deviceID, int baudRate, int dataBits, int stopBits, int parityBits, int flowControl){
        try {
            if (!posPrinter.getDeviceEnabled()) {
                return true;
            }
    ...
    public byte[] getVidPid(int deviceID){
        byte[] data = null;
        try {
            if (!posPrinter.getDeviceEnabled()) {
                return null;
            }
            data = posPrinter.getVidPid(deviceID);
        } catch (JposException e) {
            e.printStackTrace();
    ...
    public byte[] getSerialNumber(int deviceID){
        byte[] data = null;
        try {
            if (!posPrinter.getDeviceEnabled()) {
                return null;
    ...
    public byte[] getCustomUsbLists(int deviceID){
        byte[] data = null;
        try {
            if (!posPrinter.getDeviceEnabled()) {
                return null;
    ...
    public boolean addCustomUsbDevice(int deviceType, byte vidL, byte vidH, byte pidL, byte pidH){
        try {
            if (!posPrinter.getDeviceEnabled()) {
                return false;
            }
    ...
    public boolean delCustomUsbDevice(int deviceType, byte vidL, byte vidH, byte pidL, byte pidH){
        try {
            if (!posPrinter.getDeviceEnabled()) {
                return false;
            }
    ...
    public boolean resetCustomUsbDevice(int deviceType){
        try {
            if (!posPrinter.getDeviceEnabled()) {
                return false;
            }
    ...
    public void directIOOccurred(DirectIOEvent directIOEvent) {
        ...
        if (fm != null) {
            ...
            }else if(fm instanceof UsbPeripheralFragment){
                if (directIOEvent.getObject() != null) {
                    ((UsbPeripheralFragment) fm).setDeviceLog(new String((byte[]) directIOEvent.getObject()) + "\n");
                }
            }
        }
    }
    ...
    public void errorOccurred(ErrorEvent errorEvent) {
        ...
        if (fm != null) {
            if (fm instanceof TextFragment) {
                ((TextFragment) fm).setDeviceLog("Error : " + getERMessage(errorEvent.getErrorCodeExtended()));
            }

            if (fm instanceof ImageFragment) {
                ((TextFragment) fm).setDeviceLog("Error : " + getERMessage(errorEvent.getErrorCode()));
            }
